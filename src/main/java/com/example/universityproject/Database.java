...
public class Database {
    ...
    public Database() {
        ...
        movies1.add(new Movie("No time to lie", 200, 12.00, LocalDateTime.of(2021, Month.OCTOBER, 9, 20, 00), LocalDateTime.of(2021, Month.OCTOBER, 9, 22, 5)));
        ...
        movies2.add(new Movie("No time to lie", 100, 12.00, LocalDateTime.of(2021, Month.OCTOBER, 9, 20, 00), LocalDateTime.of(2021, Month.OCTOBER, 9, 22, 5)));
